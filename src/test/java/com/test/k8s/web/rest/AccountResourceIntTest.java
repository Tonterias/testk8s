...
import com.test.k8s.config.Constants;
import com.test.k8s.domain.Authority;
import com.test.k8s.domain.PersistentToken;
import com.test.k8s.domain.User;
import com.test.k8s.repository.AuthorityRepository;
import com.test.k8s.repository.PersistentTokenRepository;
import com.test.k8s.repository.UserRepository;
import com.test.k8s.security.AuthoritiesConstants;
import com.test.k8s.service.MailService;
import com.test.k8s.service.UserService;
import com.test.k8s.service.dto.PasswordChangeDTO;
import com.test.k8s.service.dto.UserDTO;
import com.test.k8s.web.rest.errors.ExceptionTranslator;
import com.test.k8s.web.rest.vm.KeyAndPasswordVM;
import com.test.k8s.web.rest.vm.ManagedUserVM;
