...
import com.test.k8s.config.audit.AuditEventConverter;
import com.test.k8s.domain.PersistentAuditEvent;
...
import static com.test.k8s.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
